        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="#nyc-real-estate" className="text-background/70 hover:text-background transition-colors duration-300">
                  NYC Real Estate
                </Link>
              </li>
              <li>
                <Link href="#property-solutions" className="text-background/70 hover:text-background transition-colors duration-300">
                  Property Solutions
                </Link>
              </li>
              <li>
                <a href="https://realprof.us/" target="_blank" rel="noopener noreferrer" className="text-background/70 hover:text-background transition-colors duration-300">
                  RealPro Solutions
                </a>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-background/20">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-background/60">
            ...
            <div className="flex flex-col md:flex-row items-center gap-2 text-center md:text-left">
              <p>Licensed NY Real Estate Salesperson</p>
